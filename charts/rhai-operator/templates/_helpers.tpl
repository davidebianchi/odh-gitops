...
Common labels
*/}}
{{- define "rhai-operator.labels" -}}
helm.sh/chart: {{ include "rhai-operator.chart" . }}
...
*/}}
{{- define "rhai-operator.disabledResourcesEnv" -}}
